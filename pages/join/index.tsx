	...
	const blocks: Block[] = [
		{
			...
			paragraphs: [
				<>
					Join the Discord if you haven&apos;t already. Having a Discord account is
					required to join, if you do not have one, you can make one for free on{" "}
					<Link
		...
		},
		{
			...
			paragraphs: [
				<>
					...
					We have an acceptance rate of about 70% so good luck! The questions are here to
					make sure that everyone who joins Streamline will follow the rules and
		...
		},
		{
			...
			paragraphs: [
				<>
					The form has been submitted. Next a staff member will review your application.
					The wait is usually no more than 24 hours. If you have any questions please ask
					our staff or you can DM me directly.
				</>,
				/*
				...
				messages: [
					{
						...
						content: (
							<>
								Unfortunately, your application for Streamline SMP got denied. You
								can still stay on the Discord server and follow content through
								various channels if you wish to do so.
							</>
						),
					},
				],
				...
				messages: [
					{
						...
						content: (
							<>
								<Mention text="@Hex32" /> Welcome to the server! You are now
								accepted and have been whitelisted! Also, make sure to set your
								notification preferences in <Mention text="#roles" /> !
							</>
						),
					},
				],
